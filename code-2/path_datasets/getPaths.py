...
ListDatasets = ['/scratch/users/jpierre/mew_0.001_noisy_v2',
                ...
                '/scratch/users/jpierre/mew_0.01_noisy_v2', 
                '/scratch/users/jpierre/mew_0.01_normal_v2',####
               '/scratch/users/jpierre/aquali_speed_upd/aquali_0.001_noisy_v2',
                '/scratch/users/jpierre/aquali_speed_upd/aquali_0.001_normal_v2', 
                '/scratch/users/jpierre/aquali_speed_upd/aquali_0.01_noisy_v2', 
                '/scratch/users/jpierre/aquali_speed_upd/aquali_0.01_normal_v2']


outputFiles = [ '/home/jpierre/v2/path_datasets/mew_0.001_noisy_v2.json',
                '/home/jpierre/v2/path_datasets/mew_0.001_normal_v2.json', 
                '/home/jpierre/v2/path_datasets/mew_0.01_noisy_v2.json', 
                '/home/jpierre/v2/path_datasets/mew_0.01_normal_v2.json',
               '/home/jpierre/v2/path_datasets/aquali_0.001_noisy_v2.json',
                '/home/jpierre/v2/path_datasets/aquali_0.001_normal_v2.json', 
                '/home/jpierre/v2/path_datasets/aquali_0.01_noisy_v2.json', 
                '/home/jpierre/v2/path_datasets/aquali_0.01_normal_v2.json']

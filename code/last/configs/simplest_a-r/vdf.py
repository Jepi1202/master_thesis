                            ...
                            for dropout in [0, 1]:
                                for nb_layer in [1]:
                                    for dataUpdate in ['delta']:
                                        for tr in ['1-step']:
                                            for modelName in ['simplest_action-react']:
                                                for nbDim in [1]:
                                                    for l1_reg in [0.0001]:
                                                        for scaleL1 in [0]:
                                                
                                                            
                                                            #wb_name = f'mt_{modelName}_{dataType}_dim{nbDim}'
                                                            wb_name = f'mt_{modelName}_{dataType}_l1_reg-{l1_reg}_dropout-{dropout}'
                                                            ...
                                                            cfg.training.tag.append(f'layer_norm-{l1_reg}')
                                                        ...
                                                        if modelName == 'simplest_action-react':
